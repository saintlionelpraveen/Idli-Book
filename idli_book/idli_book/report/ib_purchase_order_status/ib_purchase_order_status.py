...
def execute(filters=None):
	"""
	IB Purchase Order Status Report
	Shows breakdown of purchase orders by status - optimized for charts
	"""
	columns = get_columns()
...
def get_data(filters):
	"""Fetch purchase order status breakdown"""
